package com.yuanda.huixuangu.utils;
...
public final class BarUtils {
    ...
    public static int getActionBarHeight() {
        ...
        if (HuiXuanGuApplication.getInstance().getTheme().resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
            return TypedValue.complexToDimensionPixelSize(
                    tv.data, HuiXuanGuApplication.getInstance().getResources().getDisplayMetrics()
            );
        }
        return 0;
    }
    ...
    private static void invokePanels(final String methodName) {
        try {
            ...
            Object service = HuiXuanGuApplication.getInstance().getSystemService("statusbar");
    ...
    public static void setNavBarVisibility(@NonNull final Window window, boolean isVisible) {
        ...
        for (int i = 0, count = decorView.getChildCount(); i < count; i++) {
            ...
            if (id != View.NO_ID) {
                String resourceEntryName = HuiXuanGuApplication.getInstance()
                        .getResources()
    ...
    public static boolean isSupportNavBar() {
        WindowManager wm = (WindowManager) HuiXuanGuApplication.getInstance().getSystemService(Context.WINDOW_SERVICE);
        if (wm == null) {
            return false;
        }
